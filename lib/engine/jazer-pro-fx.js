...
// ============================================================================
// Usage: import { initProFX } from '../lib/engine/jazer-pro-fx.js';
//        initProFX(canvas);  // Instant pro effects!
// ============================================================================

import { FX_PRESETS, PostFXManager, getDefaultManager } from './jazer-post-fx.js';
import { CanvasPostFX, createCanvasPipeline } from './jazer-canvas-fx.js';
import { JaZeRComposer, createJazerComposer } from './jazer-three-fx.js';
 ...
 * 
 * @example
 * import { initThreeProFX } from '../lib/engine/jazer-pro-fx.js';
 * 
