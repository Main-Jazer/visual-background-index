...
class FullScreenQuad {
    constructor(THREE, material) {
        ...
        // Create a larger plane for better visibility
        this._mesh = new THREE.Mesh(
            new THREE.PlaneGeometry(2, 2),
            material
        );

        // Disable frustum culling - very important for post-processing
        this._mesh.frustumCulled = false;

        // Create a dedicated scene and camera for rendering the quad
        this._scene = new THREE.Scene();
        this._scene.add(this._mesh);

        // Camera is positioned at origin, looking at plane at z=0
